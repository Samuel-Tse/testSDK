...
//        // privacyConfig values set below are only provided to allow a quick start with capturing monitoring data
//        // this has to be requested from the user (in e.g. a privacy settings screen) and user decision has to be applied to privacyConfig
...
//        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "AdvancedTweeter")
