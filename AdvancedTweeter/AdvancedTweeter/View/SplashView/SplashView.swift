...
class SplashView: UIView {
    ...
    //---------------------------------
    public init(iconImage: UIImage, iconInitialSize:CGSize, backgroundColorTop: UIColor, backgroundColorBottom: UIColor)
    {
        ...
        self.applyGradient(colours:  [backgroundColorTop, backgroundColorBottom])
